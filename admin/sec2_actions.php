...
switch ($action) {
    case 'add':
        ...
        $query = "INSERT INTO sec2 (description, category, first_sanction, second_sanction, third_sanction) 
                 VALUES ('$description', '$category', '$first_sanction', '$second_sanction', '$third_sanction')";
    ...
    case 'update':
        if (!isset($_POST['offense_id']) || !isset($_POST['description']) || !isset($_POST['category']) || 
            !isset($_POST['first_sanction']) || !isset($_POST['second_sanction']) || 
            !isset($_POST['third_sanction'])) {
            $response['message'] = 'Missing required fields';
            break;
    ...
    case 'delete':
        ...
        $query = "DELETE FROM sec2 WHERE id = '$id'";
    ...
    case 'get':
        ...
        $id = mysqli_real_escape_string($conn, $_POST['id']);
        $query = "SELECT * FROM sec2 WHERE id = '$id'";
